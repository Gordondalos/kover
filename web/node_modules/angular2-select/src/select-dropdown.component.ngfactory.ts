...
class _View_SelectDropdownComponent2 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = this.parent.context.getOptionClass(this.context.$implicit);
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
    ...
    if (import4.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this.renderer.setElementAttribute(this._el_0,'data-value',((currVal_1 == (null as any))? (null as any): currVal_1.toString()));
      this._expr_1 = currVal_1;
    }
